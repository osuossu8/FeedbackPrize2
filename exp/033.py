...
class CFG:
    EXP_ID = '033'
    apex = True
    model = 'deepset/deberta-v3-large-squad2' # 'deepset/roberta-base-squad2' # 'xlm-roberta-base' # 't5-base' # 'microsoft/mpnet-base' # 'microsoft/deberta-v3-large'  # 'microsoft/deberta-v3-base'
    seed = 71
    n_splits = 4
    max_len = 512
    dropout = 0 # 0.2
