...
class FeedBackModel(nn.Module):
    def __init__(self, model_name):
        ...
        #self.config.hidden_act = "gelu_new"
        ...
        #self.f1 = nn.Linear(self.config.hidden_size, 1)
        #self.f2 = nn.Linear(self.config.hidden_size, 1)
        #self.f3 = nn.Linear(self.config.hidden_size, 1)
...
#         sequence_output = self.pooler(all_hidden_states)
        ...
        # logits = torch.cat([logits1, logits2, logits3], -1)
